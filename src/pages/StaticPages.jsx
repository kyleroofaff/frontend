          ...
          {visibleRequests.length === 0 ? (
            ...
            <div className="space-y-1">
              {visibleRequests.map((request) => {
                ...
                const counterpartInitials = getConversationInitials(counterpartName);
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-2">
                      <span className="mt-0.5 inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-indigo-100 text-[10px] font-bold text-indigo-700">{counterpartInitials}</span>
              ...
              <div className="flex flex-col">
                <div className="flex items-start justify-between gap-3 border-b border-rose-100 px-4 py-3">
                  <div className="min-w-0 flex items-start gap-2">
                    <span className="mt-0.5 inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-indigo-100 text-[11px] font-bold text-indigo-700">{counterpartInitials}</span>
                            ...
                            return (
                              <div className="mt-2 space-y-2">
                                <div className="rounded-lg bg-slate-50 px-3 py-2 text-[11px] text-slate-600 ring-1 ring-slate-200">
                                  {hasSavedAddress
                                    ? <>Heads up: clicking <span className="font-semibold">Accept &amp; pay</span> will ask you to confirm or edit your shipping address before charging your wallet.</>
                                    : <>Heads up: clicking <span className="font-semibold">Accept &amp; pay</span> will ask for your shipping address before charging your wallet. You only have to do this once — we'll save it to your profile for next time.</>}
                                </div>
